...
HttpHelper.prototype.constructBody = function(headers) {
    if (!this.strategy.bodyTemplate || this.strategy.bodyTemplate === '') return '';
    return interpolate(this.strategy.bodyTemplate, this.context, headers);
};
...
HttpHelper.prototype.makeRequest = function(cb) {
    ...
    params.body = this.constructBody(params.headers);
